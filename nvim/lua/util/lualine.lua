...
-- Utility function to format text with highlight groups
---@param component any
---@param text string
...
function M.format(component, text, hl_group)
  ...
  -- Cache highlight groups for better performance
...
function M.root_dir(opts)
  opts = vim.tbl_extend("force", {
    ...
    icon = "󱉭 ",
    color = function()
      return { fg = "#89b4fa" } -- Use a specific color for the root directory
    end,
  }, opts or {})
