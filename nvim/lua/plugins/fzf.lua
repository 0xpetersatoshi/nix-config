...
return {
  -- Awesome picker for FZF (alternative to Telescope)
  {
    ...
    opts = function(_, opts)
      ...
      fzf_config.defaults.keymap.fzf["ctrl-x"] = "jump"
      fzf_config.defaults.keymap.fzf["ctrl-f"] = "preview-page-down"
      fzf_config.defaults.keymap.fzf["ctrl-b"] = "preview-page-up"
      fzf_config.defaults.keymap.builtin["<c-f>"] = "preview-page-down"
      fzf_config.defaults.keymap.builtin["<c-b>"] = "preview-page-up"
      ...
      fzf_config.defaults.actions.files["alt-c"] = fzf_config.defaults.actions.files["ctrl-r"]
      fzf_config.set_action_helpstr(fzf_config.defaults.actions.files["ctrl-r"], "toggle-root-dir")
...

  {
    ...
    -- stylua: ignore
    keys = {
      { "<leader>st", function() require("todo-comments.fzf").todo() end, desc = "[S]earch [t]odo" },
      { "<leader>sT", function () require("todo-comments.fzf").todo({ keywords = { "TODO", "FIX", "FIXME" } }) end, desc = "[S]earch [T]odo/Fix/Fixme" },
    },
  },
}
