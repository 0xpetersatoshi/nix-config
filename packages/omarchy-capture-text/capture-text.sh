...
# Ported from Omarchy's `omarchy-capture-text`.
#
# Set OMARCHY_OCR_LANGS to a tesseract language spec (default: eng).
...
notify-send --app-name=screenshot "Copied text from selection to clipboard"
