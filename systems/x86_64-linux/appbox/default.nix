...
in {
  ...
  fileSystems."/mnt/appdata" = {
    device = "nas.svc.home.internal:/mnt/flashpool/appdata";
    fsType = "nfs";
    options = nfsMountOpts ["rsize=131072" "wsize=131072"];
  };

  fileSystems."/mnt/media" = {
    device = "nas.svc.home.internal:/mnt/flashpool/data";
    fsType = "nfs";
    options = nfsMountOpts ["rsize=1048576" "wsize=1048576"];
  };

  fileSystems."/mnt/immich" = {
    device = "nas.svc.home.internal:/mnt/flashpool/media/immich";
    fsType = "nfs";
    options = nfsMountOpts ["rsize=1048576" "wsize=1048576"];
  };

  fileSystems."/mnt/syncthing" = {
    device = "nas.svc.home.internal:/mnt/flashpool/syncthing";
    fsType = "nfs";
    options = nfsMountOpts ["rsize=1048576" "wsize=1048576"];
  };

  fileSystems."/mnt/nextcloud" = {
    device = "nas.svc.home.internal:/mnt/flashpool/nextcloud";
    fsType = "nfs";
    options = nfsMountOpts ["rsize=1048576" "wsize=1048576"];
  };

  fileSystems."/mnt/isos" = {
    device = "nas.svc.home.internal:/mnt/rustpool/isos";
    fsType = "nfs";
    options = nfsMountOpts ["rsize=1048576" "wsize=1048576"];
  };
